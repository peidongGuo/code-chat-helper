...
""",
    ...
    final_review = f"""**[AI Review]** This comment is generated by an AI model (gpt-4) via **v2** prompt.\n\n{response.choices[0]['message']['content'].strip()}\n
    **[Note]** 
    ...
    For further discussion with the LLM-based Reviewbot, please visit: http://8.210.154.109:32765/conversation?uuid={event_id}\n\n"""
